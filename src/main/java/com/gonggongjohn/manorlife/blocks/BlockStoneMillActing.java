...
public class BlockStoneMillActing extends BlockContainer implements IHasModel {
	
    public final String name = "stone_mill_acting";
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private boolean isActing;

    public BlockStoneMillActing(boolean isActing) {
    ...
    private ILockableContainer getContainer(World worldIn, BlockPos pos, boolean b) {
        ...
        if (!(tileentity instanceof TEStoneMillActing)) {
        	
            return null;
        }
        else {

            ILockableContainer ilockablecontainer = (TEStoneMillActing)tileentity;

            TileEntity anothorTileEntity = worldIn.getTileEntity(pos);
            ilockablecontainer = new InventoryLargeChest("", null, (TEStoneMillActing)anothorTileEntity);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof TEStoneMillActing) {
                ...
                ((TEStoneMillActing)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new ItemStack(BlockHandler.blockStoneMillActing);
    }
